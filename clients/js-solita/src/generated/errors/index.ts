...
createErrorFromNameLookup.set(
  ...
  () => new CollectionMustBeSizedError()
)
...
createErrorFromCodeLookup.set(0x178d, () => new MetadataArgsAmbiguousError())
createErrorFromNameLookup.set(
  'MetadataArgsAmbiguous',
  () => new MetadataArgsAmbiguousError()
)
...
createErrorFromCodeLookup.set(0x178e, () => new MetadataArgsMissingError())
createErrorFromNameLookup.set(
  'MetadataArgsMissing',
  () => new MetadataArgsMissingError()
)
...
createErrorFromCodeLookup.set(0x178f, () => new NFTLinkedToCollectionError())
createErrorFromNameLookup.set(
  'NFTLinkedToCollection',
  () => new NFTLinkedToCollectionError()
)
